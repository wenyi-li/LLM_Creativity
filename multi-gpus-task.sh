...
do
    python test.py --model llama-2-13b --task $i --prompt_type basic_prompt
    python test.py --model llama-2-13b --task $i --prompt_type instructive_prompt
    python test.py --model llama-2-13b --task $i --prompt_type CoT_prompt
done
#- End
